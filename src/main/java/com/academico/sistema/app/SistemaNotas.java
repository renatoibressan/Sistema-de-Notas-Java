        ...
        while (opcao != 0) {
            ...
            switch (opcao) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    List<Aluno> lista = gerenciador.listarAlunos();
                    for (Aluno aln : lista) {
                        System.out.println("\nNome do aluno: " + aln.getNome());
                        System.out.println("matricula do aluno: " + aln.getMatricula());
                        System.out.println("Notas do aluno: ");
                        for (double nt : aln.getNotas()) {
                            System.out.print(String.format("%.2f", nt) + " ");
                        }
                        try {
                            double md = aln.calcularMedia();
                            System.out.println("\nMedia: " + String.format("%.2f", md));
